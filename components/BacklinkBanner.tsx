...
export default function BacklinkBanner({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-navy-950 text-white p-6 sm:p-8 border border-navy-800 shadow-xl">
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2.5 w-full lg:w-auto">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-nyala-600 hover:bg-nyala-500 text-white font-bold text-xs sm:text-sm transition-all shadow-sm hover:scale-[1.02] active:scale-95"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-navy-800 hover:bg-navy-700 text-white font-bold text-xs sm:text-sm transition-all border border-navy-700 hover:scale-[1.02] active:scale-95"
          >
            <Laptop weight="duotone" className="w-4 h-4 text-amber-400" />
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-navy-800 hover:bg-navy-700 text-white font-bold text-xs sm:text-sm transition-all border border-navy-700 hover:scale-[1.02] active:scale-95"
          >
            <GraduationCap weight="duotone" className="w-4 h-4 text-emerald-400" />
